...
function EventWidget(props) {
  ...
  return (
    <div className='eventWidget'>
      ...
      <FontAwesomeIcon icon = {faMapMarkerAlt} /><p className='location'>{e.location}</p>
      <p className='creator'>Created by <FontAwesomeIcon icon = {faUserCircle} /> {e.creator.name}</p>
      <p className='attendees'><FontAwesomeIcon icon = {faUser} /> {attendeeList(e)}</p>
